...
$AdoBuildDefs = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$AdoBuildDef = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT

$Params = @{ RestApi = "ADO"; Service = "Build"; Operation = "Builds - List"; project = $AdoProject; organization = $AdoOrganization }
$AdoBuilds = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
```
...
$UserEntitlements = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$Members = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$UserPATs = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$Environment = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT

$Params = @{ RestApi = "ADO"; Service = "Task Agent"; Operation = "Pools - Get Agent Pools"; organization = $AdoOrganization }
$AdoAgentPools = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
$AdoAgents = @()
foreach( $Pool in $AdoAgentPools ){
   ...
   $AdoAgents += Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
}
```
...
$AdoTeams = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
foreach($Team in $AdoTeams){
   ...
   Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT -Body $Body
}
```
...
$SharedQueriesParent = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT | where-object { $_.Name -eq "Shared Queries" }

$Params = @{ RestApi = "ADO"; Service = "Work Item Tracking"; project = $AdoProject; Operation = "Queries - List"; organization = $AdoOrganization }
$AdoQueries = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$AdoQuery = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
$RanQuery = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
...
foreach($wi in $WorkItems){
   ...
   $WorkItemInfo = Invoke-crRestMethod -Params $Params -BearerToken $AdoPAT
